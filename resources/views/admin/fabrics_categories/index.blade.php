   ...
   display:none;
    ...
    <!-- tile body -->
                <div class="col-md-10 col-md-offset-1">
                                <div class="tile-body">
                                    ...
                                    <table id="searchTextResults" data-filter="#filter" data-page-size="5" class="footable table table-custom">
                                        ...
                                        <tr>
                                            <td>{!! $i !!}</td>
                                            <td>{!! $category->title_lt!!}</td>
                                            <td><a class="btn btn-primary" href="/admin/fabrics/categories/{!! $category->id !!}/edit">Redaguoti</a></td>
                ...
                <script>
                    ...
                    var input = $(this).find("#modal-category-delete-form").attr("action", "/admin/fabrics/categories/"+category_id);
                  });
                </script>
                @stop