...
@section('content')
	...
	<div class="col-md-8 col-md-offset-2">
        ...
        <form action="/admin/wallpapers" method="POST" enctype="multipart/form-data" novalidate>
			{{ csrf_field() }}
            ...
            <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="manufacturer_url" id="manufacturer" value="{!! old('manufacturer_url') !!}" class="form-control"
                           required>
                </div>

                <div class="form-group">
                  <label>Tapetų nuotraukos:</label><br/>
