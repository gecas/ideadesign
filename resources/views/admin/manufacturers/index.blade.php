   ...
   display:none;
    ...
    <!-- tile body -->
                                ...
                                <div class="tile-body">
                                    ...
                                    <table id="searchTextResults" data-filter="#filter" data-page-size="5" class="footable table table-custom">
                                        ...
                                        <tr>
                                            ...
                                            <td><img src="/{!! $category->logo_path.$category->logo_name !!}" alt="" width="100px"></td>
                                            <td><a class="btn btn-primary" href="/admin/wallpapers/categories/{!! $category->id !!}/edit">Redaguoti</a></td>
                ...
                <script>
                    ...
                    var input = $(this).find("#modal-category-delete-form").attr("action", "/admin/wallpapers/categories/"+category_id);
                  });
                </script>
                @stop