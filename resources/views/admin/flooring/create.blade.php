...
@section('content')
	...
	<div class="col-md-8 col-md-offset-2">
		<h3 class="text-center">Pridėti parketlenčių</h3>
        @include('errors.list')
        <form action="/admin/flooring" method="POST" enctype="multipart/form-data" novalidate>
			{{ csrf_field() }}
            <div class="row col-md-12">

            <div class="form-group">
                <label for="">Parketlenčių gamintojas: </label>
                ...
                <div class="form-group">
                  <label>Parketlenčių nuotraukos:</label><br/>
