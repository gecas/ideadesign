...
@section('content')
	<div class="col-md-8 col-md-offset-2">
		...
		<h3 class="text-center">Redaguoti audinių nuotrauką</h3>
            @include('errors.list')
        
            <div class="row col-md-10 col-md-offset-1">

            <form enctype="multipart/form-data" id="nav-images-form" method="POST" action="/admin/nav-images/fabrics/{!! $photo->id !!}">
        	{{ method_field('PUT') }}
			{{ csrf_field() }}
		    ...
		    <div class="col-md-12">
		            ...
		            <label for="">Audinių nuotrauka</label>
		            <img src="/{!! $photo->image_path.$photo->image_name !!}" width="250">
		            <br>
		            <label for="article_images">
		            <input id="nav_image" class="delete_image" type="checkbox" name="audiniu_photo" value=""> Ištrinti
		            </label>
		            <br>
			            <div class="nav-photo-upload">
					      <label>Audinių nuotrauka:</label><br/>
					      <input type="file" name="fabrics_image" id="file" class="inputfile" accept="image/*" />
					      <label for="file">
