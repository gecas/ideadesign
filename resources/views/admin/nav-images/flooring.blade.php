...
@section('content')
	<div class="col-md-8 col-md-offset-2">
		...
		<h3 class="text-center">Redaguoti parketlenčių nuotrauką</h3>
            @include('errors.list')
        
            <div class="row col-md-10 col-md-offset-1">

            <form enctype="multipart/form-data" id="nav-images-form" method="POST" action="/admin/nav-images/flooring/{!! $photo->id !!}">
        	{{ method_field('PUT') }}
			{{ csrf_field() }}
		    ...
		    <div class="col-md-12">
		            ...
		            <label for="">Parketlenčių nuotrauka</label>
		            <img src="/{!! $photo->image_path.$photo->image_name !!}" width="250">
		            <br>
		            <label for="article_images">
		            <input id="nav_image" class="delete_image" type="checkbox" name="parketlenciu_photo" value=""> Ištrinti
		            </label>
		            <br>
			            <div class="nav-photo-upload">
					      <label>Parketlenčių nuotrauka:</label><br/>
					      <input type="file" name="flooring_image" id="file" class="inputfile" accept="image/*" />
					      <label for="file">
